...
[![Release](https://img.shields.io/badge/release-v1.0.1-0366d6?style=flat-square)](.github/release-notes/v1.0.1.md)
...
The 1.0.1 release is a Lovelace card loading hotfix on top of the
1.0.0 media workflow release. The native C300X device agent remains `1.0.0`.
