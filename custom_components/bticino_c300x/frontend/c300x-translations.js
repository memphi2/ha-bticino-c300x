export const C300X_TRANSLATIONS = {
  en: {
    ...
    media_forwarding_required: "Ring Call requires Home Assistant forwarding",
    ...
    ringback_tone: "Home Call ringback tone",
    ringback_volume: "Home Call ringback volume",
    show_media_readiness: "Show media readiness line",
    stream: "Stream",
  ...
  de: {
    ...
    media_forwarding_required: "Ring Call benötigt Home-Assistant-Weiterleitung",
    ...
    ringback_tone: "Home-Call-Freizeichen",
    ringback_volume: "Home-Call-Freizeichen-Lautstärke",
    show_media_readiness: "Media-Readiness-Zeile anzeigen",
    stream: "Stream",
  ...
  fr: {
    ...
    media_forwarding_required: "Ring Call nécessite le transfert Home Assistant",
    ...
    ringback_tone: "Tonalité d'attente Home Call",
    ringback_volume: "Volume de tonalité Home Call",
    show_media_readiness: "Afficher la ligne Media readiness",
    stream: "Stream",
  ...
  it: {
    ...
    media_forwarding_required: "Ring Call richiede l'inoltro Home Assistant",
    ...
    ringback_tone: "Tono di attesa Home Call",
    ringback_volume: "Volume tono Home Call",
    show_media_readiness: "Mostra riga Media readiness",
    stream: "Stream",
