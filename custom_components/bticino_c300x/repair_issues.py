...
def _self_test_reason_text(check_name: str, reason: str) -> str:
    ...
    descriptions = {
        ...
        "inhouse_binary_status_failed": "the Home Assistant only routing patch status could not be read",
        "inhouse_binary_patch_missing": "the Home Assistant only routing patch is missing",
