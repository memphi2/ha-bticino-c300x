...
function alarmLabel(raw, pageItem) {
    ...
    if (raw === "armed_home") return uiText(pageItem, "armed_home")
    if (raw === "armed_away") return uiText(pageItem, "armed_away")
    if (raw === "armed_night") return uiText(pageItem, "armed_night")
    if (raw === "armed_custom_bypass") return uiText(pageItem, "armed_custom_bypass")
    if (raw === "armed_vacation") return uiText(pageItem, "armed_vacation")
